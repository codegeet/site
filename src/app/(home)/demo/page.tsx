...
export default function DemoPage() {
  ...
  return (<>
    <section className="container flex flex-col gap-6 py-8 md:max-w-[64rem] md:py-12 lg:py-24 hidden">
    ...
    <section id="live-demo" className="container py-8 md:py-4 lg:py-8">
